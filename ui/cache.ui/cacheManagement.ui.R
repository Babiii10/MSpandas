      ...
      tags$ul(
        ...
        tags$li(
          actionLink(
            ...
            label = span(icon("save"), " Save Checkpoint"),
            style = "
              display: block;
              padding: 8px 15px;
              color: #333;
        ...
        tags$li(
          actionLink(
            ...
            label = span(icon("undo"), " Restore from Cache"),
            style = "
              display: block;
              padding: 8px 15px;
              color: #333;
        ...
        tags$li(
          actionLink(
            ...
            label = span(icon("info-circle"), " View Cache Status"),
            style = "
              display: block;
              padding: 8px 15px;
              color: #666;
...
cache_inline_controls_ui <- function() {
  ...
  div(
    ...
    actionButton(
      "btn_quick_save",
      label = span(icon("save"), " Quick Save"),
      class = "btn-primary btn-sm"
    ),

    actionButton(
      "btn_quick_restore",
      label = span(icon("undo"), " Restore"),
